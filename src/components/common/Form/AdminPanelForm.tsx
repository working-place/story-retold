...
import { publishCard } from '../../../services/api/heroes';
        ...
        try {
            ...
            const response = await httpClient<{ id: number }>('/api/card/create', {
                ...
                body: JSON.stringify({
                    ...
                    privacyPolicy: true,
                    published: true,
                    dateDeath: formData.dateDeath || undefined,
                    email: formData.email || undefined,
                    militaryRank: formData.militaryRank || undefined,
                    placeService: formData.placeService || undefined,
                    placeConscription: formData.placeConscription || undefined,
                }),
            });
