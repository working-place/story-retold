        ...
        <div className={styles.overlay} onClick={onClose}>
            <div className={styles.confirmPopup} onClick={(e) => e.stopPropagation()}>
                ...
                <div className={styles.content}>
                    ...
                    <p className={styles.confirmPopup__subtitle}>
                        Это действие невозможно отменить. <br />
                        Все данные карточки будут безвозвратно удалены.
                    </p>

                    <div className={styles.confirmPopup__buttons}>
                        <Button
                            type="button"
                            className={styles.confirmPopup__cancelButton}
                            onClick={onClose}
                            disabled={isLoading}
                        >
                            Отмена
                        ...
                        <Button
                            type="button"
                            className={styles.confirmPopup__confirmButton}
                            onClick={onConfirm}
                            disabled={isLoading}
                        >
