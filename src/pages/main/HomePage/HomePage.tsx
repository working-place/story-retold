...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <picture>
                <source
                    className={styles.history_source}
            ...
            <div className={styles.history}>
                ...
                <div className={styles.history_mapMobile_container}>
                    <img
            ...
            <div className={styles.about}>
                ...
                <picture>
                    ...
                    <img
                        className={styles.divide_2}
                        src="/homePage_PaperDivider_mobile.png" alt="Разделительная линия" />
                </picture>

                <div className={styles.about_subtitle}>
                    <h2
                        className={`${styles.about_subtitle__firstLine} ${styles.about_subtitle__firstLine_center}`}
                        style={{ fontFamily: 'Glanz', fontWeight: 400 }}
                    >
                        О проекте История,
                    </h2>
                    <h2
                        className={`${styles.about_subtitle__firstLine} ${styles.about_subtitle__firstLine_left}`}
                        style={{ fontFamily: 'Glanz', fontWeight: 400 }}
                    >
                        РАССКАЗАННАЯ ЗАНОВО
                    </h2>
                    <h2
                        className={`${styles.about_subtitle__firstLine} ${styles.about_subtitle__firstLine_mobile}`}
                        style={{ fontFamily: 'Glanz', fontWeight: 400 }}
                    >
                        РАССКАЗАННАЯ
                    </h2>
